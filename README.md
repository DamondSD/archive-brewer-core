...
│     ├─ contracts/
│     │  ├─ blueprint-shape.mjs
│     │  ├─ brewer-registration.mjs
│     │  ├─ exporter-contract.mjs
│     │  └─ validation-contract.mjs
│     ├─ registry/
│     │  ├─ brewer-registry.mjs
│     │  ├─ adapter-registry.mjs
│     │  └─ exporter-registry.mjs
│     ├─ app/
│     │  ├─ brewer-base-app.mjs
│     │  └─ form-binding.mjs
│     ├─ document/
│     │  ├─ source-document.mjs
│     │  ├─ document-normalizer.mjs
│     │  └─ document-versioning.mjs
│     ├─ validation/
│     │  └─ validation-runner.mjs
│     ├─ template/
│     │  └─ template-registry.mjs
│     ├─ storage/
│     │  ├─ compendium-helper.mjs
│     │  └─ save-helper.mjs
│     └─ utilities/
│        └─ logger.mjs
├─ templates/
...
8. storage helpers
9. public api
10. brewer integration

This keeps the foundation stable before higher-level integration begins.
...
Initial architecture planning is complete.
